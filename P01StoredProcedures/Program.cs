...
string password = "RcRK4K5f9Cbt";

string connectionString = "Server=tcp:volleyballservws.database.windows.net,1433;Initial Catalog=VolleyballDB;Persist Security Info=False;User ID=wowo2211;Password=" + password + "; MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
